...
import com.example.luck_rent_android.databinding.ActivityBuildingPreviewBinding
...
class BuildingPreview : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var  binding : ActivityBuildingPreviewBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = DataBindingUtil.setContentView(this,R.layout.activity_building_preview)
    ...
    private fun setTopBar(){
        ...
        binding?.topBar?.tvText?.text = "Add Building Preview"
    ...
    private fun setRecycler(){
        adapter = BuildingAdapter(this, list){ mItem, pos ->}
