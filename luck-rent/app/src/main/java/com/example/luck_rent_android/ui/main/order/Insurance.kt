...
class Insurance : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var binding : ActivityInsuranceBinding? = null
    ...
    private fun setTopBar() {
        ...
        binding?.topBar?.tvText?.text = "Insurance"
