...
import com.example.luck_rent_android.databinding.ActivityCreditCheckBinding
...
class CreditCheck : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var binding : ActivityCreditCheckBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = DataBindingUtil.setContentView(this,R.layout.activity_credit_check)
    ...
    private fun setTopBar(){
        ...
        binding?.topBar?.tvText?.text = "Credit Check"
