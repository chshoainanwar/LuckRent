...
import com.example.luck_rent_android.databinding.ActivityRentCollectionBinding
import com.example.luck_rent_android.databinding.ActivityRentEstimationBinding
...
class RentCollection : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var binding: ActivityRentCollectionBinding? = null

    private var mDataSideItem = ArrayList<SideItems>()
    private var mTopDataSideItem = ArrayList<SideItems>()

    override fun onCreate(savedInstanceState: Bundle?) {
        binding = DataBindingUtil.setContentView(this,R.layout.activity_rent_collection)
        ...
        binding?.tvLink?.setOnClickListener {
            ...
            openURL.data = Uri.parse("https://zumrails.com/")
    ...
    private fun setTopBar() {
        ...
        binding?.topBar?.tvText?.text = "Rent Collection"
