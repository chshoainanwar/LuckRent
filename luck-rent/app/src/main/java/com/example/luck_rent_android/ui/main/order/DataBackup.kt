...
import com.example.luck_rent_android.databinding.ActivityDataBackupBinding
...
class DataBackup : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var binding : ActivityDataBackupBinding? = null

    private var mDataSideItem = ArrayList<SideItems>()
    private var mTopDataSideItem = ArrayList<SideItems>()

    override fun onCreate(savedInstanceState: Bundle?) {
        binding = DataBindingUtil.setContentView(this,R.layout.activity_data_backup)
    ...
    private fun setTopBar() {
        ...
        binding?.topBar?.tvText?.text = "Data Backup"
