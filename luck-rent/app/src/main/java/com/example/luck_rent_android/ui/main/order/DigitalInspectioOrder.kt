...
import com.example.luck_rent_android.databinding.ActivityDigitalInspectioOrderBinding
...
class DigitalInspectioOrder : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var binding: ActivityDigitalInspectioOrderBinding? = null

    private var mDataSideItem = ArrayList<SideItems>()
    private var mTopDataSideItem = ArrayList<SideItems>()
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = DataBindingUtil.setContentView(this,R.layout.activity_digital_inspectio_order)
