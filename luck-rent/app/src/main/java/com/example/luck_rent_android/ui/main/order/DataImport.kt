...
import com.example.luck_rent_android.databinding.ActivityDataImportBinding
import com.example.luck_rent_android.databinding.ActivityInsuranceBinding
...
class DataImport : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var binding : ActivityDataImportBinding? = null

    private var mDataSideItem = ArrayList<SideItems>()
    private var mTopDataSideItem = ArrayList<SideItems>()
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = DataBindingUtil.setContentView(this,R.layout.activity_data_import)
        ...
        binding?.ivLogo?.setOnClickListener {
            ...
            openURL.data = Uri.parse("https://www.dropbox.com/login")
    ...
    private fun setTopBar() {
        ...
        binding?.topBar?.tvText?.text = "Data Import"
